...
local theme = beautiful.init("~/.config/awesome/themes/nordic/theme.lua")
...
globalkeys = gears.table.join(
	...
	end, { description = "clear notifications", group = "system" }),

	-- Menubar
	awful.key({ modkey }, "p", function()
		awful.spawn("rofi -show powermenu -modi powermenu:rofi-power")
...
-- Autostart
awful.spawn.with_shell("/home/cheewei/.config/screenlayout/1920x1200.sh")
awful.spawn.with_shell("/home/cheewei/.config/awesome/autorun.sh")
